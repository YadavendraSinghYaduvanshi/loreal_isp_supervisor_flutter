...
class OQADSellingSkills extends StatefulWidget {
/*  String promoter_id;

  // In the constructor, require a Todo
  OQADSellingSkills({Key key, @required this.promoter_id})
      : super(key: key);*/

  @override
  _OQADSellingSkillsState createState() =>
      _OQADSellingSkillsState();
}

class _OQADSellingSkillsState
    extends State<OQADSellingSkills> {
        ...
        body: Container(
          ...
          child: new Column(
            children: <Widget>[
              ...
              new Expanded(
                  child: FutureBuilder<List<OQAD_SELLING_SKILLS>>(
                    future: fetchData(),
...
List<OQAD_SELLING_SKILLS> parsePhotos(String responseBody) {
  ...
  var list = test1['OQAD_SELLING_SKILLS'] as List;
  statusList =
  list.map((i) => OQAD_SELLING_SKILLS.fromJson(i)).toList();
...
class OQAD_SELLING_SKILLS {
  ...
  factory OQAD_SELLING_SKILLS.fromJson(Map<String, dynamic> json) {
    return OQAD_SELLING_SKILLS(
...
class StatusList extends StatelessWidget {
  final List<OQAD_SELLING_SKILLS> status;
